...
// RLS. Poblado exclusivamente por TenantContextGuard a partir del JWT ya validado - nunca
// del body/query del cliente (docs/05-CONVENCIONES-BACKEND.md SS7).
//
// Implementado sobre nestjs-cls (AsyncLocalStorage) en vez de un provider REQUEST-scoped de
// Nest: el Prisma Client Extension de tenant scoping se construye una unica vez sobre el
